 ...
 *
 * This brush was originally provided by "mjneish", created by user "n-l-i-d", modified by Avi Aryan
...
{ regex: /\S+\s+(?=:=)/g, css: 'variable' }, // variables
{ regex: /\w+:\s+/g, css: 'label' }, // labels
{ regex: /\:\=|\%|\!|\#/g, css: 'preprocessor' }, // symbols

{ regex: /\w+(?=\()/g, css: 'functions' }, // variables
